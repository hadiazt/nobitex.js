    ...
    return new Promise((resolve) => {
        axios(config).then(data => {
            ...
            resolve({
                ...
                BackDetails: { BankCards: req.bankCards, BankAccounts: req.bankAccounts },
                ...
                Options: {
                    Fee: req.options.fee,
                    FeeUSDT: req.options.feeUsdt,
                    Discount: req.options.discount,
                    IsManualFee: req.options.isManualFee,
                    TFA: req.options.tfa,
                    SocialLoginEnabled: req.options.socialLoginEnabled
                },
                Features: req.features,
                ChatID: req.chatId,
                WithdrawEligible: req.withdrawEligible,
            })
